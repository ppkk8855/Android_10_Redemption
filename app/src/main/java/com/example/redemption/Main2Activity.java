...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        N4 = "0";
        N5 = "0";
        T1=findViewById(R.id.N_1);
        T2=findViewById(R.id.N_2);
        T3=findViewById(R.id.N_3);
        T4=findViewById(R.id.N_4);
        T5=findViewById(R.id.N_5);
        ...
        Button button1=findViewById(R.id.ans);
